...
BEGIN { use_ok('Seco::Range', qw/expand_range range_set_altpath/) }
...
# BROKEN  These are more acting like AwesomeRange bh(@stress) etc
TODO: {
 local $TODO = '^foo is acting like bh(foo), needs fixing';
