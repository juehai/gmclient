package Seco::Gemstone::YAML::Error;
use strict;
...
sub new {
    ...
    $msg =~ s/\\n/\n/g;
    $class = 'Seco::Gemstone::YAML::Warning' if $severity eq 'WARN';
...
sub dump {
    my ($self) = @_;
    local $Seco::Gemstone::YAML::Indent = 4;
    local $Seco::Gemstone::YAML::UseHeader = 1;
    local $Seco::Gemstone::YAML::UseVersion = 0;
    local $Seco::Gemstone::YAML::SortKeys = [qw(code msg line document)];
    Seco::Gemstone::YAML::Dump($self)
} 
...
YAML_LOAD_USAGE
  usage: Seco::Gemstone::YAML::Load($yaml_stream_scalar)
...
package Seco::Gemstone::YAML::Warning;
use base 'Seco::Gemstone::YAML::Error';
